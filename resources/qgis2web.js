...
map.getView().fit([-5714938.319849, -3515228.944551, -5714446.013979, -3514922.363174], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Logradouros de Guaíba</h2>';
        return titleElement;
    })(),
